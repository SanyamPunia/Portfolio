        ...
        <div className="mx-auto  w-1/3 2xl:w-2/4 lg:w-4/5">
            ...
            <div className="my-28">
                ...
                <div className="flex flex-col gap-6 mb-10">
                    <p className="font-source_code_pro text-base text-bgBlack dark:text-mainWhite">2020 was the year when I decided to put my music out on the internet. Uploading it to <a target="_blank" rel="noreferrer" className="text-mainPurple dark:text-mainGreen transition dark:hover:text-mainWhite" href="https://soundcloud.com/prodmxle">SoundCloud</a>, <a target="_blank" rel="noreferrer" className="text-mainPurple dark:text-mainGreen transition dark:hover:text-mainWhite" href="https://open.spotify.com/artist/2QbtOIjb8mUIsnCNqvyWAW">Spotify</a> and other platforms helped me gather bunch of people that enjoyed listening to my music.</p>
                    ...
                    <p className="font-source_code_pro text-base text-bgBlack dark:text-mainWhite">The transition from making beats to actual full tracks took some time and in mid 2020, I finally decided to try and make electronic genre. On 23rd of September, I released my very first electronic EP &apos;<a rel="noreferrer" className="text-mainPurple dark:text-mainGreen  transition dark:hover:text-mainWhite" target="_blank" href="https://soundcloud.com/prodmxle/sets/a-light-in-the-dark?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing">a light in the dark</a>&apos; along with a self designed &apos;<a rel="noreferrer" target="_blank" className="text-mainPurple dark:text-mainGreen  transition dark:hover:text-mainWhite" href="https://payhip.com/b/pQdaY">sample pack</a>&apos;, which was indeed a great success for me.</p>
